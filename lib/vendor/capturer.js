...
var Capturer = {
    ...
    postImg: function () {
        ...
        jQuery('.img').css('background-image', "url(" +screenshotUrl + ")");
        jQuery('button.upload').attr('disabled', false)
        window.upload_url = screenshotUrl
        //$('.img').attr('src', screenshotUrl);
        //chrome.runtime.sendMessage({msg: 'fullpage', url: screenshotUrl});
